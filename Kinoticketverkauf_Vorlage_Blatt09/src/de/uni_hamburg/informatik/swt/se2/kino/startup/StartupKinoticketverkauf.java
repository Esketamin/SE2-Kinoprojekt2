...
public class StartupKinoticketverkauf
{
    ...
    private static Kino erzeugeKinoMitBeispieldaten()
    {
        ...
        Geldbetrag p500 = Geldbetrag.get(500);
        Geldbetrag p700 = Geldbetrag.get(700);
        Geldbetrag p800 = Geldbetrag.get(800);
        Geldbetrag p900 = Geldbetrag.get(900);
        Geldbetrag p1000 = Geldbetrag.get(1000);
